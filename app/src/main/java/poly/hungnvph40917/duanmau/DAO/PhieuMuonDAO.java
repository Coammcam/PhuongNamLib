...
public class PhieuMuonDAO {
    ...
    public boolean themPhieuMuon(PhieuMuon phieuMuon) {
        SQLiteDatabase sqLiteDatabase = dbHelper.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        // mapm INTEGER PRIMARY KEY AUTOINCREMENT, matv INTEGER REFERENCES THANHVIEN(matv), matt TEXT REFERENCES THUTHU(matt), maSach INTEGER REFERENCES SACH(maSach), ngay TEXT NOT NULL, traSach INTEGER NOT NULL, tienthue INTEGER NOT NULL
